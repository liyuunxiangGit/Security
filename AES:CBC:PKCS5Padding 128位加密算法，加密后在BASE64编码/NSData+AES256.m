...
//#define PASSWORD @"ACHeJfoWQgaYBpia"
//#define PASSWORD @"Per vallum duces Labant"
#define PASSWORD @"Escuela de comunicacion"

static const char encodingTable[] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
//const NSUInteger kAlgorithmKeySize = kCCKeySizeAES256;//修改为128
...
static Byte ivBuff[]   = {5,8,6,3,4,2,8,6,3,6,4,9,6,5,9,3};
//static Byte ivBuff[] = 0x00;//去掉iv效率是一样的，还是不去掉了。
...
+ (NSData *)AESKeyForPassword:(NSString *)password{                  //Derive a key from a text password/passphrase
    ...
    NSData *salt = [NSData dataWithBytes:saltBuff length:kCCKeySizeAES128]; //这里原来是128
    //这里有个128
...
+ (NSString *)AES256EncryptWithPlainText:(NSString *)plain {
    ...
    //	char keyPtr[kCCKeySizeAES256+1]; // room for terminator (unused)修改为128
    ...
    CCCryptorStatus cryptStatus = CCCrypt(kCCEncrypt, kCCAlgorithmAES128,kCCOptionPKCS7Padding,
                                          [[NSData AESKeyForPassword:PASSWORD] bytes], kCCKeySizeAES128,//修改为128
                                          //                                          kCCKeySizeAES256
...
+ (NSString *)AES256DecryptWithCiphertext:(NSString *)ciphertexts{
    ...
    // 'key' should be 32 bytes for AES256, will be null-padded otherwise
    char keyPtr[kCCKeySizeAES128+1]; // room for terminator (unused)//kCCKeySizeAES128 //修改为128
    bzero(keyPtr, sizeof(keyPtr)); // fill with zeroes (for padding)
